...
import { SPEC_URL, SPEC_SECTIONS, type SpecId } from './spec';
import {
  bytesToHex,
  bytesToUtf8,
  hexToBytes,
  ...
  <main class="shell">
    <header class="cl-hero">
      <div class="cl-hero-main">
        ...
        <p class="cl-hero-desc">Encrypt, decrypt, and tamper with a message through a 768-bit six-block AEGIS-256 state, verified live against the RFC 10032 Appendix A.3 vectors.</p>
      </div>
    ...
    <div class="hero-strip">
      ...
      <div id="conformance" class="conformance" role="status" aria-live="polite">
        ...
        <span class="conformance-text">Replaying RFC 10032 vectors in your browser&hellip;</span>
      ...
      <div id="conformance-details" class="table-wrap" role="region" aria-label="Per-vector conformance results" tabindex="0" hidden>
        <table class="conformance-table">
          <caption class="visually-hidden">Per-vector conformance results: ciphertext, 128-bit tag, 256-bit tag, and decrypt round-trip for each RFC 10032 encryption test vector</caption>
          <thead><tr><th scope="col">RFC vector</th><th scope="col">Ciphertext</th><th scope="col">128-bit tag</th><th scope="col">256-bit tag</th><th scope="col">Round-trip</th></tr></thead>
    ...
    <section class="panel" id="exhibit-2">
      ...
      <p class="note">Watch the spec execute: every button below runs this implementation's real functions on the key/nonce/AD/plaintext from Exhibit 1, the diagram shows where the bytes flow, and the pseudocode pane highlights the part of <a href="${SPEC_URL}" target="_blank" rel="noopener">RFC 10032</a> that just ran. Bytes that changed since the previous step glow gold.</p>
      <div class="sm-layout">
        <div class="sm-left">
          <div class="actions">
      ...
      <div class="table-wrap" role="region" aria-label="AEGIS comparison table" tabindex="0">
        <table>
          ...
          <tbody>
            ...
            <tr><td>Standardization</td><td>IRTF Informational RFC 10032</td><td>NIST / RFC ecosystem</td><td>RFC 8439</td></tr>
          </tbody>
        </table>
      </div>
    ...
    <section class="panel" id="exhibit-6">
      ...
      <p>AEGIS has implementations across the ecosystem &mdash; including libsodium and the Zig standard library &mdash; and is of active interest for high-throughput systems where AES hardware acceleration is available. <a href="${SPEC_URL}" target="_blank" rel="noopener">RFC 10032</a> was published in September 2026 as an IRTF Informational RFC reflecting CFRG consensus, not an Internet Standard or a TLS cipher suite. A <a href="https://datatracker.ietf.org/doc/draft-denis-tls-aegis/" target="_blank" rel="noopener">companion draft</a> proposes AEGIS cipher suites for TLS 1.3, DTLS 1.3, and QUIC.</p>
      <h3>The AEGIS family (<a href="${SPEC_URL}#section-3" target="_blank" rel="noopener">RFC 10032 &sect;3&ndash;5</a>)</h3>
...
function renderConformance(): void {
  ...
  text.textContent = report.allPass
    ? `${report.passed}/${report.total} RFC 10032 vectors conform - ${report.rows.length} encryptions reproduced byte-for-byte (with decrypt round-trip), ${report.rejections.length} forgeries rejected.`
